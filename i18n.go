...
//
// Slice 0 of the i18n milestone: the engine, language resolution, and a Preferences
// picker are in place, but call sites still use literal English strings — they get
// migrated to i18n.T(...) in later slices. See docs/I18N-SCOPE.md.
package main
