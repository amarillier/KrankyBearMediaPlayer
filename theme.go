//go:generate fyne bundle -o bundled.go assets/images/KrankyBearMediaPlayer.png
//go:generate fyne bundle -o bundled.go -a assets/images/KrankyBearMediaPlayer.png
//go:generate fyne bundle -o bundled.go -a assets/images/KrankyBearMediaPlayer.png
